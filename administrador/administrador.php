  ...
  <body>
    ...
    <div class="container">
      <div class="header clearfix">
        ...
        <h3 class="text-muted">Bienbenidos al login del Administrador</h3>
      </div>
      ...
      <div class="jumbotron">
		...
		<form action="validar.php" method="post" name="form">
			<table>
				...
				<tr>
					<td></td>
					<td><a href="http://127.0.0.1/ing_web_2015/web_app4_05_05_2015/administrador/contrasena.php">olvidó su clave</a></td>
				</tr>
			</table>		
		</form>
		</div>
