    ...
    <div id="admin" class="container-fluid">
      <div class="row">
        ...
        <?php 
          ...
          if ($act==1) {
            $miconexion->consulta("delete from ".$var2." where id=$id");
            echo "<script>location.href='menu4.php?va=$var2'</script>";
          }
          echo "<ul id='ingresar'><li><a id='ingresar' href='http://127.0.0.1/ing_web_2015/taller/include/ingresar.php?var=$var2'>Ingresar</a></li></ul>";
         ?>
        </div>
      </div>
    </div>
